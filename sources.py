...
ai_sources += prepend_dir('move', ['move.cpp', 'collection.cpp', 'container.cpp', 'power.cpp', 'pp.cpp', 'ranked.cpp', 'reorder.cpp', 'shared.cpp', 'times_used.cpp', 'use_move.cpp'])
...
predict_sources += prepend_dir('move', ['move.cpp', 'collection.cpp', 'container.cpp', 'pp.cpp', 'ranked.cpp', 'reorder.cpp', 'shared.cpp', 'times_used.cpp'])
...
test_sources += prepend_dir('move', ['move.cpp', 'collection.cpp', 'container.cpp', 'power.cpp', 'pp.cpp', 'ranked.cpp', 'reorder.cpp', 'shared.cpp', 'times_used.cpp'])
