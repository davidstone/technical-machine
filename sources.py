...
ai_sources += ['move/move.cpp', 'move/collection.cpp', 'move/container.cpp', 'move/power.cpp', 'move/pp.cpp', 'move/ranked.cpp', 'move/reorder.cpp', 'move/shared.cpp', 'move/use_move.cpp']
...
predict_sources += ['move/move.cpp', 'move/collection.cpp', 'move/container.cpp', 'move/pp.cpp', 'move/ranked.cpp', 'move/reorder.cpp', 'move/shared.cpp']
...
test_sources += ['move/move.cpp', 'move/collection.cpp', 'move/container.cpp', 'move/power.cpp', 'move/pp.cpp', 'move/ranked.cpp', 'move/reorder.cpp', 'move/shared.cpp']
