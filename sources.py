...
predict_sources = ['predictor.cpp', 'ability.cpp', 'detailed_stats.cpp', 'gender.cpp', 'item.cpp', 'load_stats.cpp', 'move.cpp', 'move_collection.cpp', 'move_container.cpp', 'nature.cpp', 'pokemon.cpp', 'pokemon_collection.cpp', 'reorder_moves.cpp', 'shared_moves.cpp', 'stage.cpp', 'stat.cpp', 'status.cpp', 'team.cpp', 'team_predictor.cpp', 'type.cpp', 'type_collection.cpp', 'variable.cpp', 'variable_collection.cpp', 'weather.cpp']
...
test_sources += ['ability.cpp', 'damage.cpp', 'gender.cpp', 'item.cpp', 'move.cpp', 'move_collection.cpp', 'move_container.cpp', 'move_power.cpp', 'nature.cpp', 'pokemon.cpp', 'pokemon_collection.cpp', 'reorder_moves.cpp', 'shared_moves.cpp', 'stage.cpp', 'stat.cpp', 'status.cpp', 'team.cpp', 'type.cpp', 'type_collection.cpp', 'variable.cpp', 'variable_collection.cpp', 'weather.cpp']
