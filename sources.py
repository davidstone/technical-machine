...
ai_sources = ['ai.cpp', 'ability.cpp', 'battle.cpp', 'battle_result.cpp', 'block.cpp', 'damage.cpp', 'endofturn.cpp', 'entry_hazards.cpp', 'evaluate.cpp', 'expectiminimax.cpp', 'gender.cpp', 'heal.cpp', 'item.cpp', 'nature.cpp', 'screen.cpp', 'screens.cpp', 'settings_file.cpp', 'stage.cpp', 'stat.cpp', 'status.cpp', 'switch.cpp', 'team.cpp', 'transposition.cpp', 'type.cpp', 'type_collection.cpp', 'vanish.cpp', 'variable.cpp', 'variable_collection.cpp', 'weather.cpp', 'wish.cpp']
...
ai_sources += prepend_dir('pokemon', ['pokemon.cpp', 'collection.cpp', 'seen.cpp'])
...
predict_sources = ['ability.cpp', 'damage.cpp', 'entry_hazards.cpp', 'gender.cpp', 'heal.cpp', 'item.cpp', 'nature.cpp', 'screen.cpp', 'screens.cpp', 'stage.cpp', 'stat.cpp', 'status.cpp', 'team.cpp', 'type.cpp', 'type_collection.cpp', 'vanish.cpp', 'variable.cpp', 'variable_collection.cpp', 'weather.cpp', 'wish.cpp']
...
predict_sources += prepend_dir('pokemon', ['pokemon.cpp', 'collection.cpp', 'seen.cpp'])
...
test_sources += ['ability.cpp', 'damage.cpp', 'entry_hazards.cpp', 'gender.cpp', 'heal.cpp', 'item.cpp', 'nature.cpp', 'screen.cpp', 'screens.cpp', 'stage.cpp', 'stat.cpp', 'status.cpp', 'team.cpp', 'type.cpp', 'type_collection.cpp', 'vanish.cpp', 'variable.cpp', 'variable_collection.cpp', 'weather.cpp', 'wish.cpp']
...
test_sources += prepend_dir('pokemon', ['pokemon.cpp', 'collection.cpp', 'seen.cpp'])
