...
predict_sources = ['predictor.cpp', 'ability.cpp', 'gender.cpp', 'item.cpp', 'load_stats.cpp', 'move.cpp', 'move_collection.cpp', 'nature.cpp', 'pokemon.cpp', 'pokemon_collection.cpp', 'reorder_moves.cpp', 'stat.cpp', 'status.cpp', 'team.cpp', 'team_predictor.cpp', 'type.cpp', 'variable_collection.cpp', 'weather.cpp']
...
test_sources += ['ability.cpp', 'damage.cpp', 'gender.cpp', 'item.cpp', 'move.cpp', 'move_collection.cpp', 'move_power.cpp', 'nature.cpp', 'pokemon.cpp', 'pokemon_collection.cpp', 'reorder_moves.cpp', 'stat.cpp', 'status.cpp', 'team.cpp', 'type.cpp', 'variable_collection.cpp', 'weather.cpp']
