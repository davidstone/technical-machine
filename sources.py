...
test_sources += ['ability.cpp', 'damage.cpp', 'entry_hazards.cpp', 'gender.cpp', 'heal.cpp', 'item.cpp', 'nature.cpp', 'pokemon.cpp', 'pokemon_collection.cpp', 'screen.cpp', 'stage.cpp', 'stat.cpp', 'status.cpp', 'team.cpp', 'type.cpp', 'type_collection.cpp', 'vanish.cpp', 'variable.cpp', 'variable_collection.cpp', 'weather.cpp', 'wish.cpp']
