...
class Move {
	public:
		...
		uint16_t base_power() const;
		bool is_boosted_by_technician() const;
		...
		// I suspect I can get rid of the score variable entirely. I can save it
		// as int16_t because it stores no intermediate calculations.
		int16_t score;
		Moves name;
	...
	private:
		...
		// Potentially replace this with a function
		uint8_t cached_base_power;

		// Replace this with a function when it will reduce the size of Move if
		// I can find out what to do about Hidden Power
		Type cached_type;
