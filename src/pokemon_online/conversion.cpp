...
Moves id_to_move (unsigned id) {
	constexpr static Moves move_converter [] = {
		Moves::END, Moves::POUND, Moves::KARATE_CHOP,
		Moves::DOUBLESLAP, Moves::COMET_PUNCH, Moves::MEGA_PUNCH,
		Moves::PAY_DAY, Moves::FIRE_PUNCH, Moves::ICE_PUNCH,
		Moves::THUNDERPUNCH, Moves::SCRATCH, Moves::VICEGRIP,
		Moves::GUILLOTINE, Moves::RAZOR_WIND, Moves::SWORDS_DANCE,
		Moves::CUT, Moves::GUST, Moves::WING_ATTACK,
		Moves::WHIRLWIND, Moves::FLY, Moves::BIND,
		Moves::SLAM, Moves::VINE_WHIP, Moves::STOMP,
		Moves::DOUBLE_KICK, Moves::MEGA_KICK, Moves::JUMP_KICK,
		Moves::ROLLING_KICK, Moves::SAND_ATTACK, Moves::HEADBUTT,
		Moves::HORN_ATTACK, Moves::FURY_ATTACK, Moves::HORN_DRILL,
		Moves::TACKLE, Moves::BODY_SLAM, Moves::WRAP,
		Moves::TAKE_DOWN, Moves::THRASH, Moves::DOUBLE_EDGE,
		Moves::TAIL_WHIP, Moves::POISON_STING, Moves::TWINEEDLE,
		Moves::PIN_MISSILE, Moves::LEER, Moves::BITE,
		Moves::GROWL, Moves::ROAR, Moves::SING,
		Moves::SUPERSONIC, Moves::SONICBOOM, Moves::DISABLE,
		Moves::ACID, Moves::EMBER, Moves::FLAMETHROWER,
		Moves::MIST, Moves::WATER_GUN, Moves::HYDRO_PUMP,
		Moves::SURF, Moves::ICE_BEAM, Moves::BLIZZARD,
		Moves::PSYBEAM, Moves::BUBBLEBEAM, Moves::AURORA_BEAM,
		Moves::HYPER_BEAM, Moves::PECK, Moves::DRILL_PECK,
		Moves::SUBMISSION, Moves::LOW_KICK, Moves::COUNTER,
		Moves::SEISMIC_TOSS, Moves::STRENGTH, Moves::ABSORB,
		Moves::MEGA_DRAIN, Moves::LEECH_SEED, Moves::GROWTH,
		Moves::RAZOR_LEAF, Moves::SOLARBEAM, Moves::POISONPOWDER,
		Moves::STUN_SPORE, Moves::SLEEP_POWDER, Moves::PETAL_DANCE,
		Moves::STRING_SHOT, Moves::DRAGON_RAGE, Moves::FIRE_SPIN,
		Moves::THUNDERSHOCK, Moves::THUNDERBOLT, Moves::THUNDER_WAVE,
		Moves::THUNDER, Moves::ROCK_THROW, Moves::EARTHQUAKE,
		Moves::FISSURE, Moves::DIG, Moves::TOXIC,
		Moves::CONFUSION, Moves::PSYCHIC, Moves::HYPNOSIS,
		Moves::MEDITATE, Moves::AGILITY, Moves::QUICK_ATTACK,
		Moves::RAGE, Moves::TELEPORT, Moves::NIGHT_SHADE,
		Moves::MIMIC, Moves::SCREECH, Moves::DOUBLE_TEAM,
		Moves::RECOVER, Moves::HARDEN, Moves::MINIMIZE,
		Moves::SMOKESCREEN, Moves::CONFUSE_RAY, Moves::WITHDRAW,
		Moves::DEFENSE_CURL, Moves::BARRIER, Moves::LIGHT_SCREEN,
		Moves::HAZE, Moves::REFLECT, Moves::FOCUS_ENERGY,
		Moves::BIDE, Moves::METRONOME, Moves::MIRROR_MOVE,
		Moves::SELFDESTRUCT, Moves::EGG_BOMB, Moves::LICK,
		Moves::SMOG, Moves::SLUDGE, Moves::BONE_CLUB,
		Moves::FIRE_BLAST, Moves::WATERFALL, Moves::CLAMP,
		Moves::SWIFT, Moves::SKULL_BASH, Moves::SPIKE_CANNON,
		Moves::CONSTRICT, Moves::AMNESIA, Moves::KINESIS,
		Moves::SOFTBOILED, Moves::HI_JUMP_KICK, Moves::GLARE,
		Moves::DREAM_EATER, Moves::POISON_GAS, Moves::BARRAGE,
		Moves::LEECH_LIFE, Moves::LOVELY_KISS, Moves::SKY_ATTACK,
		Moves::TRANSFORM, Moves::BUBBLE, Moves::DIZZY_PUNCH,
		Moves::SPORE, Moves::FLASH, Moves::PSYWAVE,
		Moves::SPLASH, Moves::ACID_ARMOR, Moves::CRABHAMMER,
		Moves::EXPLOSION, Moves::FURY_SWIPES, Moves::BONEMERANG,
		Moves::REST, Moves::ROCK_SLIDE, Moves::HYPER_FANG,
		Moves::SHARPEN, Moves::CONVERSION, Moves::TRI_ATTACK,
		Moves::SUPER_FANG, Moves::SLASH, Moves::SUBSTITUTE,
		Moves::STRUGGLE, Moves::SKETCH, Moves::TRIPLE_KICK,
		Moves::THIEF, Moves::SPIDER_WEB, Moves::MIND_READER,
		Moves::NIGHTMARE, Moves::FLAME_WHEEL, Moves::SNORE,
		Moves::CURSE, Moves::FLAIL, Moves::CONVERSION2,
		Moves::AEROBLAST, Moves::COTTON_SPORE, Moves::REVERSAL,
		Moves::SPITE, Moves::POWDER_SNOW, Moves::PROTECT,
		Moves::MACH_PUNCH, Moves::SCARY_FACE, Moves::FAINT_ATTACK,
		Moves::SWEET_KISS, Moves::BELLY_DRUM, Moves::SLUDGE_BOMB,
		Moves::MUD_SLAP, Moves::OCTAZOOKA, Moves::SPIKES,
		Moves::ZAP_CANNON, Moves::FORESIGHT, Moves::DESTINY_BOND,
		Moves::PERISH_SONG, Moves::ICY_WIND, Moves::DETECT,
		Moves::BONE_RUSH, Moves::LOCK_ON, Moves::OUTRAGE,
		Moves::SANDSTORM, Moves::GIGA_DRAIN, Moves::ENDURE,
		Moves::CHARM, Moves::ROLLOUT, Moves::FALSE_SWIPE,
		Moves::SWAGGER, Moves::MILK_DRINK, Moves::SPARK,
		Moves::FURY_CUTTER, Moves::STEEL_WING, Moves::MEAN_LOOK,
		Moves::ATTRACT, Moves::SLEEP_TALK, Moves::HEAL_BELL,
		Moves::RETURN, Moves::PRESENT, Moves::FRUSTRATION,
		Moves::SAFEGUARD, Moves::PAIN_SPLIT, Moves::SACRED_FIRE,
		Moves::MAGNITUDE, Moves::DYNAMICPUNCH, Moves::MEGAHORN,
		Moves::DRAGONBREATH, Moves::BATON_PASS, Moves::ENCORE,
		Moves::PURSUIT, Moves::RAPID_SPIN, Moves::SWEET_SCENT,
		Moves::IRON_TAIL, Moves::METAL_CLAW, Moves::VITAL_THROW,
		Moves::MORNING_SUN, Moves::SYNTHESIS, Moves::MOONLIGHT,
		Moves::HIDDEN_POWER, Moves::CROSS_CHOP, Moves::TWISTER,
		Moves::RAIN_DANCE, Moves::SUNNY_DAY, Moves::CRUNCH,
		Moves::MIRROR_COAT, Moves::PSYCH_UP, Moves::EXTREMESPEED,
		Moves::ANCIENTPOWER, Moves::SHADOW_BALL, Moves::FUTURE_SIGHT,
		Moves::ROCK_SMASH, Moves::WHIRLPOOL, Moves::BEAT_UP,
		Moves::FAKE_OUT, Moves::UPROAR, Moves::STOCKPILE,
		Moves::SPIT_UP, Moves::SWALLOW, Moves::HEAT_WAVE,
		Moves::HAIL, Moves::TORMENT, Moves::FLATTER,
		Moves::WILL_O_WISP, Moves::MEMENTO, Moves::FACADE,
		Moves::FOCUS_PUNCH, Moves::SMELLINGSALT, Moves::FOLLOW_ME,
		Moves::NATURE_POWER, Moves::CHARGE, Moves::TAUNT,
		Moves::HELPING_HAND, Moves::TRICK, Moves::ROLE_PLAY,
		Moves::WISH, Moves::ASSIST, Moves::INGRAIN,
		Moves::SUPERPOWER, Moves::MAGIC_COAT, Moves::RECYCLE,
		Moves::REVENGE, Moves::BRICK_BREAK, Moves::YAWN,
		Moves::KNOCK_OFF, Moves::ENDEAVOR, Moves::ERUPTION,
		Moves::SKILL_SWAP, Moves::IMPRISON, Moves::REFRESH,
		Moves::GRUDGE, Moves::SNATCH, Moves::SECRET_POWER,
		Moves::DIVE, Moves::ARM_THRUST, Moves::CAMOUFLAGE,
		Moves::TAIL_GLOW, Moves::LUSTER_PURGE, Moves::MIST_BALL,
		Moves::FEATHERDANCE, Moves::TEETER_DANCE, Moves::BLAZE_KICK,
		Moves::MUD_SPORT, Moves::ICE_BALL, Moves::NEEDLE_ARM,
		Moves::SLACK_OFF, Moves::HYPER_VOICE, Moves::POISON_FANG,
		Moves::CRUSH_CLAW, Moves::BLAST_BURN, Moves::HYDRO_CANNON,
		Moves::METEOR_MASH, Moves::ASTONISH, Moves::WEATHER_BALL,
		Moves::AROMATHERAPY, Moves::FAKE_TEARS, Moves::AIR_CUTTER,
		Moves::OVERHEAT, Moves::ODOR_SLEUTH, Moves::ROCK_TOMB,
		Moves::SILVER_WIND, Moves::METAL_SOUND, Moves::GRASSWHISTLE,
		Moves::TICKLE, Moves::COSMIC_POWER, Moves::WATER_SPOUT,
		Moves::SIGNAL_BEAM, Moves::SHADOW_PUNCH, Moves::EXTRASENSORY,
		Moves::SKY_UPPERCUT, Moves::SAND_TOMB, Moves::SHEER_COLD,
		Moves::MUDDY_WATER, Moves::BULLET_SEED, Moves::AERIAL_ACE,
		Moves::ICICLE_SPEAR, Moves::IRON_DEFENSE, Moves::BLOCK,
		Moves::HOWL, Moves::DRAGON_CLAW, Moves::FRENZY_PLANT,
		Moves::BULK_UP, Moves::BOUNCE, Moves::MUD_SHOT,
		Moves::POISON_TAIL, Moves::COVET, Moves::VOLT_TACKLE,
		Moves::MAGICAL_LEAF, Moves::WATER_SPORT, Moves::CALM_MIND,
		Moves::LEAF_BLADE, Moves::DRAGON_DANCE, Moves::ROCK_BLAST,
		Moves::SHOCK_WAVE, Moves::WATER_PULSE, Moves::DOOM_DESIRE,
		Moves::PSYCHO_BOOST, Moves::ROOST, Moves::GRAVITY,
		Moves::MIRACLE_EYE, Moves::WAKE_UP_SLAP, Moves::HAMMER_ARM,
		Moves::GYRO_BALL, Moves::HEALING_WISH, Moves::BRINE,
		Moves::NATURAL_GIFT, Moves::FEINT, Moves::PLUCK,
		Moves::TAILWIND, Moves::ACUPRESSURE, Moves::METAL_BURST,
		Moves::U_TURN, Moves::CLOSE_COMBAT, Moves::PAYBACK,
		Moves::ASSURANCE, Moves::EMBARGO, Moves::FLING,
		Moves::PSYCHO_SHIFT, Moves::TRUMP_CARD, Moves::HEAL_BLOCK,
		Moves::WRING_OUT, Moves::POWER_TRICK, Moves::GASTRO_ACID,
		Moves::LUCKY_CHANT, Moves::ME_FIRST, Moves::COPYCAT,
		Moves::POWER_SWAP, Moves::GUARD_SWAP, Moves::PUNISHMENT,
		Moves::LAST_RESORT, Moves::WORRY_SEED, Moves::SUCKER_PUNCH,
		Moves::TOXIC_SPIKES, Moves::HEART_SWAP, Moves::AQUA_RING,
		Moves::MAGNET_RISE, Moves::FLARE_BLITZ, Moves::FORCE_PALM,
		Moves::AURA_SPHERE, Moves::ROCK_POLISH, Moves::POISON_JAB,
		Moves::DARK_PULSE, Moves::NIGHT_SLASH, Moves::AQUA_TAIL,
		Moves::SEED_BOMB, Moves::AIR_SLASH, Moves::X_SCISSOR,
		Moves::BUG_BUZZ, Moves::DRAGON_PULSE, Moves::DRAGON_RUSH,
		Moves::POWER_GEM, Moves::DRAIN_PUNCH, Moves::VACUUM_WAVE,
		Moves::FOCUS_BLAST, Moves::ENERGY_BALL, Moves::BRAVE_BIRD,
		Moves::EARTH_POWER, Moves::SWITCHEROO, Moves::GIGA_IMPACT,
		Moves::NASTY_PLOT, Moves::BULLET_PUNCH, Moves::AVALANCHE,
		Moves::ICE_SHARD, Moves::SHADOW_CLAW, Moves::THUNDER_FANG,
		Moves::ICE_FANG, Moves::FIRE_FANG, Moves::SHADOW_SNEAK,
		Moves::MUD_BOMB, Moves::PSYCHO_CUT, Moves::ZEN_HEADBUTT,
		Moves::MIRROR_SHOT, Moves::FLASH_CANNON, Moves::ROCK_CLIMB,
		Moves::DEFOG, Moves::TRICK_ROOM, Moves::DRACO_METEOR,
		Moves::DISCHARGE, Moves::LAVA_PLUME, Moves::LEAF_STORM,
		Moves::POWER_WHIP, Moves::ROCK_WRECKER, Moves::CROSS_POISON,
		Moves::GUNK_SHOT, Moves::IRON_HEAD, Moves::MAGNET_BOMB,
		Moves::STONE_EDGE, Moves::CAPTIVATE, Moves::STEALTH_ROCK,
		Moves::GRASS_KNOT, Moves::CHATTER, Moves::JUDGMENT,
		Moves::BUG_BITE, Moves::CHARGE_BEAM, Moves::WOOD_HAMMER,
		Moves::AQUA_JET, Moves::ATTACK_ORDER, Moves::DEFEND_ORDER,
		Moves::HEAL_ORDER, Moves::HEAD_SMASH, Moves::DOUBLE_HIT,
		Moves::ROAR_OF_TIME, Moves::SPACIAL_REND, Moves::LUNAR_DANCE,
		Moves::CRUSH_GRIP, Moves::MAGMA_STORM, Moves::DARK_VOID,
		Moves::SEED_FLARE, Moves::OMINOUS_WIND, Moves::SHADOW_FORCE
	};
...
unsigned move_to_id (Moves move) {
	...
	return move_converter [(move < Moves::SWITCH0) ? index : index - 6];
}
