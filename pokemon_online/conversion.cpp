...
Ability::Abilities id_to_ability (int id) {
	static Ability::Abilities const ability_converter [] = { Ability::END_ABILITY, Ability::STENCH, Ability::DRIZZLE, Ability::SPEED_BOOST, Ability::BATTLE_ARMOR, Ability::STURDY, Ability::DAMP, Ability::LIMBER, Ability::SAND_VEIL, Ability::STATIC, Ability::VOLT_ABSORB, Ability::WATER_ABSORB, Ability::OBLIVIOUS, Ability::CLOUD_NINE, Ability::COMPOUNDEYES, Ability::INSOMNIA, Ability::COLOR_CHANGE, Ability::IMMUNITY, Ability::FLASH_FIRE, Ability::SHIELD_DUST, Ability::OWN_TEMPO, Ability::SUCTION_CUPS, Ability::INTIMIDATE, Ability::SHADOW_TAG, Ability::ROUGH_SKIN, Ability::WONDER_GUARD, Ability::LEVITATE, Ability::EFFECT_SPORE, Ability::SYNCHRONIZE, Ability::CLEAR_BODY, Ability::NATURAL_CURE, Ability::LIGHTNINGROD, Ability::SERENE_GRACE, Ability::SWIFT_SWIM, Ability::CHLOROPHYLL, Ability::ILLUMINATE, Ability::TRACE, Ability::HUGE_POWER, Ability::POISON_POINT, Ability::INNER_FOCUS, Ability::MAGMA_ARMOR, Ability::WATER_VEIL, Ability::MAGNET_PULL, Ability::SOUNDPROOF, Ability::RAIN_DISH, Ability::SAND_STREAM, Ability::PRESSURE, Ability::THICK_FAT, Ability::EARLY_BIRD, Ability::FLAME_BODY, Ability::RUN_AWAY, Ability::KEEN_EYE, Ability::HYPER_CUTTER, Ability::PICKUP, Ability::TRUANT, Ability::HUSTLE, Ability::CUTE_CHARM, Ability::PLUS, Ability::MINUS, Ability::FORECAST, Ability::STICKY_HOLD, Ability::SHED_SKIN, Ability::GUTS, Ability::MARVEL_SCALE, Ability::LIQUID_OOZE, Ability::OVERGROW, Ability::BLAZE, Ability::TORRENT, Ability::SWARM, Ability::ROCK_HEAD, Ability::DROUGHT, Ability::ARENA_TRAP, Ability::VITAL_SPIRIT, Ability::WHITE_SMOKE, Ability::PURE_POWER, Ability::SHELL_ARMOR, Ability::AIR_LOCK, Ability::TANGLED_FEET, Ability::MOTOR_DRIVE, Ability::RIVALRY, Ability::STEADFAST, Ability::SNOW_CLOAK, Ability::GLUTTONY, Ability::ANGER_POINT, Ability::UNBURDEN, Ability::HEATPROOF, Ability::SIMPLE, Ability::DRY_SKIN, Ability::DOWNLOAD, Ability::IRON_FIST, Ability::POISON_HEAL, Ability::ADAPTABILITY, Ability::SKILL_LINK, Ability::HYDRATION, Ability::SOLAR_POWER, Ability::QUICK_FEET, Ability::NORMALIZE, Ability::SNIPER, Ability::MAGIC_GUARD, Ability::NO_GUARD, Ability::STALL, Ability::TECHNICIAN, Ability::LEAF_GUARD, Ability::KLUTZ, Ability::MOLD_BREAKER, Ability::SUPER_LUCK, Ability::AFTERMATH, Ability::ANTICIPATION, Ability::FOREWARN, Ability::UNAWARE, Ability::TINTED_LENS, Ability::FILTER, Ability::SLOW_START, Ability::SCRAPPY, Ability::STORM_DRAIN, Ability::ICE_BODY, Ability::SOLID_ROCK, Ability::SNOW_WARNING, Ability::HONEY_GATHER, Ability::FRISK, Ability::RECKLESS, Ability::MULTITYPE, Ability::FLOWER_GIFT, Ability::BAD_DREAMS };
	return ability_converter [id];
}

int ability_to_id (Ability::Abilities ability) {
	static int const ability_converter [] = {
		91,		// ADAPTABILITY
		106,		// AFTERMATH
		76,		// AIR_LOCK
		83,		// ANGER_POINT
...
Nature::Natures id_to_nature (int id) {
	static Nature::Natures const nature_converter [] = {
		Nature::HARDY,
		Nature::LONELY,
		Nature::BRAVE,
		Nature::ADAMANT,
...
int nature_to_id (Nature::Natures nature) {
	static int const nature_converter [] = {
		3,		// Adamant
		18,		// Bashful
		5,		// Bold
		2,		// Brave
