...
predict_sources += prepend_dir('team_predictor/ev_optimizer', ['ev_optimizer.cpp', 'offensive.cpp'])
...
test_sources += prepend_dir('team_predictor/ev_optimizer', ['ev_optimizer.cpp', 'offensive.cpp'])
