...
active_pokemon_sources = ['active_pokemon.cpp', 'confusion.cpp', 'partial_trap.cpp', 'perish_song.cpp', 'substitute.cpp', 'taunt.cpp', 'toxic.cpp', 'uproar.cpp', 'vanish.cpp', 'yawn.cpp'] + bide_sources
