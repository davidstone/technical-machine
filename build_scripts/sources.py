...
ai_sources += prepend_dir('team_predictor', ['detailed_stats.cpp', 'load_stats.cpp', 'multiplier.cpp', 'team_predictor.cpp'])
...
predict_sources += prepend_dir('team_predictor', ['detailed_stats.cpp', 'load_stats.cpp', 'multiplier.cpp', 'predictor.cpp', 'random_team.cpp', 'team_predictor.cpp'])
