...
ev_optimizer_sources = prepend_dir('team_predictor/ev_optimizer', ['defensive.cpp', 'defensive_data_point.cpp', 'ev_optimizer.cpp', 'offensive.cpp', 'single_classification_evs.cpp', 'speed.cpp'])
