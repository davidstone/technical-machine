...
predict_sources = ['ability.cpp', 'damage.cpp', 'entry_hazards.cpp', 'gender.cpp', 'heal.cpp', 'item.cpp', 'screen.cpp', 'screens.cpp', 'substitute.cpp', 'status.cpp', 'taunt.cpp', 'team.cpp', 'toxic.cpp', 'vanish.cpp', 'variable.cpp', 'variable_collection.cpp', 'weather.cpp', 'wish.cpp']
...
test_sources += ['ability.cpp', 'damage.cpp', 'entry_hazards.cpp', 'gender.cpp', 'heal.cpp', 'item.cpp', 'screen.cpp', 'screens.cpp', 'status.cpp', 'substitute.cpp', 'taunt.cpp', 'team.cpp', 'toxic.cpp', 'vanish.cpp', 'variable.cpp', 'variable_collection.cpp', 'weather.cpp', 'wish.cpp']
