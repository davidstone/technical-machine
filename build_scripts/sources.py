...
ai_sources = ['ai.cpp', 'ability.cpp', 'active_pokemon.cpp', 'block.cpp', 'damage.cpp', 'endofturn.cpp', 'entry_hazards.cpp', 'evaluate.cpp', 'expectiminimax.cpp', 'gender.cpp', 'heal.cpp', 'item.cpp', 'partial_trap.cpp', 'screen.cpp', 'screens.cpp', 'settings_file.cpp', 'status.cpp', 'substitute.cpp', 'switch.cpp', 'taunt.cpp', 'team.cpp', 'toxic.cpp', 'transposition.cpp', 'uproar.cpp', 'vanish.cpp', 'variable.cpp', 'variable_collection.cpp', 'weather.cpp', 'wish.cpp', 'yawn.cpp']
...
predict_sources = ['ability.cpp', 'active_pokemon.cpp', 'damage.cpp', 'entry_hazards.cpp', 'gender.cpp', 'heal.cpp', 'item.cpp', 'partial_trap.cpp', 'screen.cpp', 'screens.cpp', 'substitute.cpp', 'status.cpp', 'taunt.cpp', 'team.cpp', 'toxic.cpp', 'uproar.cpp', 'vanish.cpp', 'variable.cpp', 'variable_collection.cpp', 'weather.cpp', 'wish.cpp', 'yawn.cpp']
...
test_sources += ['ability.cpp', 'active_pokemon.cpp', 'damage.cpp', 'entry_hazards.cpp', 'gender.cpp', 'heal.cpp', 'item.cpp', 'partial_trap.cpp', 'screen.cpp', 'screens.cpp', 'status.cpp', 'substitute.cpp', 'taunt.cpp', 'team.cpp', 'toxic.cpp', 'uproar.cpp', 'vanish.cpp', 'variable.cpp', 'variable_collection.cpp', 'weather.cpp', 'wish.cpp', 'yawn.cpp']
