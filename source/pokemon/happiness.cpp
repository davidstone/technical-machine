...
bounded_integer::native_integer<0, 102> return_power(Happiness const happiness) {
	return happiness.m_value * 2_bi / 5_bi;
}
bounded_integer::native_integer<0, 102> frustration_power(Happiness const happiness) {
