...
Species from_string(std::string const & str) {
	static std::map <std::string, Species> const converter {
		...
		{ "wormadam-plant", Species::Wormadam_P },
		{ "wormadam", Species::Wormadam_P },
		{ "wormadam-s", Species::Wormadam_S },
		{ "wormadam-sandy", Species::Wormadam_S },
		{ "wormadam-g", Species::Wormadam_S },
		{ "wormadam-t", Species::Wormadam_T },
		{ "wormadam-trash", Species::Wormadam_T },
		//{ "wormadam-s", Species::Wormadam_T },	// Uh-oh!
		...
		{ "rotom-heat", Species::Rotom_H },
		{ "rotom-w", Species::Rotom_W },
		{ "rotom-wash", Species::Rotom_W },
		{ "rotom-f", Species::Rotom_F },
		{ "rotom-frost", Species::Rotom_F },
		{ "rotom-s", Species::Rotom_S },
		{ "rotom-spin", Species::Rotom_S },
		{ "rotom-c", Species::Rotom_C },
		{ "rotom-cut", Species::Rotom_C },
		{ "rotom-m", Species::Rotom_C },
		{ "rotom-mow", Species::Rotom_C },
		{ "uxie", Species::Uxie },
		...
		{ "giratina-altered", Species::Giratina_A },
		{ "giratina", Species::Giratina_A },
		{ "giratina-o", Species::Giratina_O },
		{ "giratina-origin", Species::Giratina_O },
		...
		{ "basculin-red", Species::Basculin_R },
		{ "basculin-b", Species::Basculin_B },
		{ "basculin-blue", Species::Basculin_B },
		{ "basculin", Species::Basculin_B },	// assume blue?
		...
		{ "tornadus-incarnate", Species::Tornadus_I },
		{ "tornadus-t", Species::Tornadus_T },
		{ "tornadus-therian", Species::Tornadus_T },
		{ "thundurus-i", Species::Thundurus_I },
		{ "thundurus-incarnate", Species::Thundurus_I },
		{ "thundurus-t", Species::Thundurus_T },
		{ "thundurus-therian", Species::Thundurus_T },
		{ "reshiram", Species::Reshiram },
		{ "zekrom", Species::Zekrom },
		{ "landorus-i", Species::Landorus_I },
		{ "landorus-incarnate", Species::Landorus_I },
		{ "landorus-t", Species::Landorus_T },
		{ "landorus-therian", Species::Landorus_T },
