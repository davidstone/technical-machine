...
constexpr auto make_team(Environment const environment, containers::c_array<InitialPokemon<special_input_style_for(generation)>, size> && pokemon) -> Team<generation> {
