...
auto parse_strategy(int argc, char const * const * argv) -> Strategy {
	...
	if (name == "random"sv) {
		...
		throw std::runtime_error("Selection strategy must be one of random, random_weighted, max_damage, net_hp, statistical");
	}
}
