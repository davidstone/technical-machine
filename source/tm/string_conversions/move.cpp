...
auto from_string(std::string_view const str) -> Moves {
	static constexpr auto converter = containers::basic_flat_map(
		...
		containers::to_array<containers::map_value_type<std::string_view, Moves>>({
			...
			{"howl", Moves::Howl},
			{"hpbug", Moves::Hidden_Power},
			{"hpdark", Moves::Hidden_Power},
			{"hpdragon", Moves::Hidden_Power},
			{"hpelectric", Moves::Hidden_Power},
			{"hpfighting", Moves::Hidden_Power},
			{"hpfire", Moves::Hidden_Power},
			{"hpflying", Moves::Hidden_Power},
			{"hpghost", Moves::Hidden_Power},
			{"hpgrass", Moves::Hidden_Power},
			{"hpground", Moves::Hidden_Power},
			{"hpice", Moves::Hidden_Power},
			{"hppoison", Moves::Hidden_Power},
			{"hppsychic", Moves::Hidden_Power},
			{"hprock", Moves::Hidden_Power},
			{"hpsteel", Moves::Hidden_Power},
			{"hpwater", Moves::Hidden_Power},
