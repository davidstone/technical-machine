...
void update_estimate(Estimate & estimate, UsageStats const & usage_stats, any_team auto const & team) {
...
void random_team(UsageStats const & usage_stats, any_team auto & team, std::mt19937 & random_engine) {
