...
constexpr auto get_type(Generation const generation, Species const species) {
	switch (species) {
		...
		case Species::Deoxys_Normal: return make_types(Type::Psychic);
		...
		// Generation 6
		case Species::Chespin: return make_types(Type::Grass);
		case Species::Quilladin: return make_types(Type::Grass);
		case Species::Chesnaught: return make_types(Type::Grass, Type::Fighting);
		case Species::Fennekin: return make_types(Type::Fire);
		case Species::Braixen: return make_types(Type::Fire);
		case Species::Delphox: return make_types(Type::Fire, Type::Psychic);
		case Species::Froakie: return make_types(Type::Water);
		case Species::Frogadier: return make_types(Type::Water);
		case Species::Greninja: return make_types(Type::Water, Type::Dark);
		case Species::Bunnelby: return make_types(Type::Normal);
		case Species::Diggersby: return make_types(Type::Normal, Type::Ground);
		case Species::Fletchling: return make_types(Type::Normal, Type::Flying);
		case Species::Fletchinder: return make_types(Type::Fire, Type::Flying);
		case Species::Talonflame: return make_types(Type::Fire, Type::Flying);
		case Species::Scatterbug: return make_types(Type::Bug);
		case Species::Spewpa: return make_types(Type::Bug);
		case Species::Vivillon: return make_types(Type::Bug, Type::Flying);
		case Species::Litleo: return make_types(Type::Fire, Type::Normal);
		case Species::Pyroar: return make_types(Type::Fire, Type::Normal);
		case Species::Flabebe: return make_types(Type::Fairy);
		case Species::Floette: return make_types(Type::Fairy);
		case Species::Florges: return make_types(Type::Fairy);
		case Species::Skiddo: return make_types(Type::Grass);
		case Species::Gogoat: return make_types(Type::Grass);
		case Species::Pancham: return make_types(Type::Fighting);
		case Species::Pangoro: return make_types(Type::Fighting, Type::Dark);
		case Species::Furfrou: return make_types(Type::Normal);
		case Species::Espurr: return make_types(Type::Psychic);
		case Species::Meowstic: return make_types(Type::Psychic);
		case Species::Honedge: return make_types(Type::Steel, Type::Ghost);
		case Species::Doublade: return make_types(Type::Steel, Type::Ghost);
		case Species::Aegislash: return make_types(Type::Steel, Type::Ghost);
		case Species::Spritzee: return make_types(Type::Fairy);
		case Species::Aromatisse: return make_types(Type::Fairy);
		case Species::Swirlix: return make_types(Type::Fairy);
		case Species::Slurpuff: return make_types(Type::Fairy);
		case Species::Inkay: return make_types(Type::Dark, Type::Psychic);
		case Species::Malamar: return make_types(Type::Dark, Type::Psychic);
		case Species::Binacle: return make_types(Type::Rock, Type::Water);
		case Species::Barbaracle: return make_types(Type::Rock, Type::Water);
		case Species::Skrelp: return make_types(Type::Poison, Type::Water);
		case Species::Dragalge: return make_types(Type::Poison, Type::Dragon);
		case Species::Clauncher: return make_types(Type::Water);
		case Species::Clawitzer: return make_types(Type::Water);
		case Species::Helioptile: return make_types(Type::Electric, Type::Normal);
		case Species::Heliolisk: return make_types(Type::Electric, Type::Normal);
		case Species::Tyrunt: return make_types(Type::Rock, Type::Dragon);
		case Species::Tyrantrum: return make_types(Type::Rock, Type::Dragon);
		case Species::Amaura: return make_types(Type::Rock, Type::Ice);
		case Species::Aurorus: return make_types(Type::Rock, Type::Ice);
		case Species::Sylveon: return make_types(Type::Fairy);
		case Species::Hawlucha: return make_types(Type::Fighting, Type::Flying);
		case Species::Dedenne: return make_types(Type::Electric, Type::Fairy);
		case Species::Carbink: return make_types(Type::Rock, Type::Fairy);
		case Species::Goomy: return make_types(Type::Dragon);
		case Species::Sliggoo: return make_types(Type::Dragon);
		case Species::Goodra: return make_types(Type::Dragon);
		case Species::Klefki: return make_types(Type::Steel, Type::Fairy);
		case Species::Phantump: return make_types(Type::Ghost, Type::Grass);
		case Species::Trevenant: return make_types(Type::Ghost, Type::Grass);
		case Species::Pumpkaboo_Small: return make_types(Type::Ghost, Type::Grass);
		case Species::Pumpkaboo_Average: return make_types(Type::Ghost, Type::Grass);
		case Species::Pumpkaboo_Large: return make_types(Type::Ghost, Type::Grass);
		case Species::Pumpkaboo_Super: return make_types(Type::Ghost, Type::Grass);
		case Species::Gourgeist_Small: return make_types(Type::Ghost, Type::Grass);
		case Species::Gourgeist_Average: return make_types(Type::Ghost, Type::Grass);
		case Species::Gourgeist_Large: return make_types(Type::Ghost, Type::Grass);
		case Species::Gourgeist_Super: return make_types(Type::Ghost, Type::Grass);
		case Species::Bergmite: return make_types(Type::Ice);
		case Species::Avalugg: return make_types(Type::Ice);
		case Species::Noibat: return make_types(Type::Flying, Type::Dragon);
		case Species::Noivern: return make_types(Type::Flying, Type::Dragon);
		case Species::Xerneas: return make_types(Type::Fairy);
		case Species::Yveltal: return make_types(Type::Dark, Type::Flying);
		case Species::Zygarde_50: return make_types(Type::Dragon, Type::Ground);
		case Species::Zygarde_10: return make_types(Type::Dragon, Type::Ground);
		case Species::Zygarde_Complete: return make_types(Type::Dragon, Type::Ground);
		case Species::Diancie: return make_types(Type::Rock, Type::Fairy);
		case Species::Hoopa_Confined: return make_types(Type::Psychic, Type::Ghost);
		case Species::Hoopa_Unbound: return make_types(Type::Psychic, Type::Dark);
		case Species::Volcanion: return make_types(Type::Fire, Type::Water);

		// Generation 7
		case Species::Rowlet: return make_types(Type::Grass, Type::Flying);
		case Species::Dartrix: return make_types(Type::Grass, Type::Flying);
		case Species::Decidueye: return make_types(Type::Grass, Type::Ghost);
		case Species::Litten: return make_types(Type::Fire);
		case Species::Torracat: return make_types(Type::Fire);
		case Species::Incineroar: return make_types(Type::Fire, Type::Dark);
		case Species::Popplio: return make_types(Type::Water);
		case Species::Brionne: return make_types(Type::Water);
		case Species::Primarina: return make_types(Type::Water, Type::Fairy);
		case Species::Pikipek: return make_types(Type::Normal, Type::Flying);
		case Species::Trumbeak: return make_types(Type::Normal, Type::Flying);
		case Species::Toucannon: return make_types(Type::Normal, Type::Flying);
		case Species::Yungoos: return make_types(Type::Normal);
		case Species::Gumshoos: return make_types(Type::Normal);
		case Species::Grubbin: return make_types(Type::Bug);
		case Species::Charjabug: return make_types(Type::Bug, Type::Electric);
		case Species::Vikavolt: return make_types(Type::Bug, Type::Electric);
		case Species::Crabrawler: return make_types(Type::Fighting);
		case Species::Crabominable: return make_types(Type::Fighting, Type::Ice);
		case Species::Oricorio: return make_types(Type::Fire, Type::Flying);
		case Species::Oricorio_Pau: return make_types(Type::Electric, Type::Flying);
		case Species::Oricorio_Pom_Pom: return make_types(Type::Psychic, Type::Flying);
		case Species::Oricorio_Sensu: return make_types(Type::Ghost, Type::Flying);
		case Species::Cutiefly: return make_types(Type::Bug, Type::Fairy);
		case Species::Ribombee: return make_types(Type::Bug, Type::Fairy);
		case Species::Rockruff: return make_types(Type::Rock);
		case Species::Lycanroc_Midday: return make_types(Type::Rock);
		case Species::Lycanroc_Midnight: return make_types(Type::Rock);
		case Species::Lycanroc_Dusk: return make_types(Type::Rock);
		case Species::Wishiwashi_Solo: return make_types(Type::Water);
		case Species::Wishiwashi_School: return make_types(Type::Water);
		case Species::Mareanie: return make_types(Type::Poison, Type::Water);
		case Species::Toxapex: return make_types(Type::Poison, Type::Water);
		case Species::Mudbray: return make_types(Type::Ground);
		case Species::Mudsdale: return make_types(Type::Ground);
		case Species::Dewpider: return make_types(Type::Water, Type::Bug);
		case Species::Araquanid: return make_types(Type::Water, Type::Bug);
		case Species::Fomantis: return make_types(Type::Grass);
		case Species::Lurantis: return make_types(Type::Grass);
		case Species::Morelull: return make_types(Type::Grass, Type::Fairy);
		case Species::Shiinotic: return make_types(Type::Grass, Type::Fairy);
		case Species::Salandit: return make_types(Type::Poison, Type::Fire);
		case Species::Salazzle: return make_types(Type::Poison, Type::Fire);
		case Species::Stufful: return make_types(Type::Normal, Type::Fighting);
		case Species::Bewear: return make_types(Type::Normal, Type::Fighting);
		case Species::Bounsweet: return make_types(Type::Grass);
		case Species::Steenee: return make_types(Type::Grass);
		case Species::Tsareena: return make_types(Type::Grass);
		case Species::Comfey: return make_types(Type::Fairy);
		case Species::Oranguru: return make_types(Type::Normal, Type::Psychic);
		case Species::Passimian: return make_types(Type::Fighting);
		case Species::Wimpod: return make_types(Type::Bug, Type::Water);
		case Species::Golisopod: return make_types(Type::Bug, Type::Water);
		case Species::Sandygast: return make_types(Type::Ghost, Type::Ground);
		case Species::Palossand: return make_types(Type::Ghost, Type::Ground);
		case Species::Pyukumuku: return make_types(Type::Water);
		case Species::Type_Null: return make_types(Type::Normal);
		case Species::Silvally: return make_types(Type::Normal);
		case Species::Minior_Meteor: return make_types(Type::Rock, Type::Flying);
		case Species::Minior_Core: return make_types(Type::Rock, Type::Flying);
		case Species::Komala: return make_types(Type::Normal);
		case Species::Turtonator: return make_types(Type::Fire, Type::Dragon);
		case Species::Togedemaru: return make_types(Type::Electric, Type::Steel);
		case Species::Mimikyu: return make_types(Type::Ghost, Type::Fairy);
		case Species::Bruxish: return make_types(Type::Water, Type::Psychic);
		case Species::Drampa: return make_types(Type::Normal, Type::Dragon);
		case Species::Dhelmise: return make_types(Type::Ghost, Type::Grass);
		case Species::Jangmo_o: return make_types(Type::Dragon);
		case Species::Hakamo_o: return make_types(Type::Dragon, Type::Fighting);
		case Species::Kommo_o: return make_types(Type::Dragon, Type::Fighting);
		case Species::Tapu_Koko: return make_types(Type::Electric, Type::Fairy);
		case Species::Tapu_Lele: return make_types(Type::Psychic, Type::Fairy);
		case Species::Tapu_Bulu: return make_types(Type::Grass, Type::Fairy);
		case Species::Tapu_Fini: return make_types(Type::Water, Type::Fairy);
		case Species::Cosmog: return make_types(Type::Psychic);
		case Species::Cosmoem: return make_types(Type::Psychic);
		case Species::Solgaleo: return make_types(Type::Psychic, Type::Steel);
		case Species::Lunala: return make_types(Type::Psychic, Type::Ghost);
		case Species::Nihilego: return make_types(Type::Rock, Type::Poison);
		case Species::Buzzwole: return make_types(Type::Bug, Type::Fighting);
		case Species::Pheromosa: return make_types(Type::Bug, Type::Fighting);
		case Species::Xurkitree: return make_types(Type::Electric);
		case Species::Celesteela: return make_types(Type::Steel, Type::Flying);
		case Species::Kartana: return make_types(Type::Grass, Type::Steel);
		case Species::Guzzlord: return make_types(Type::Dark, Type::Dragon);
		case Species::Necrozma: return make_types(Type::Psychic);
		case Species::Necrozma_Dusk_Mane: return make_types(Type::Psychic);
		case Species::Necrozma_Dawn_Wings: return make_types(Type::Psychic);
		case Species::Necrozma_Ultra: return make_types(Type::Psychic);
		case Species::Magearna: return make_types(Type::Steel, Type::Fairy);
		case Species::Marshadow: return make_types(Type::Fighting, Type::Ghost);
		case Species::Poipole: return make_types(Type::Poison);
		case Species::Naganadel: return make_types(Type::Poison, Type::Dragon);
		case Species::Stakataka: return make_types(Type::Rock, Type::Steel);
		case Species::Blacephalon: return make_types(Type::Fire, Type::Ghost);
		case Species::Zeraora: return make_types(Type::Electric);
		case Species::Rattata_Alolan: return make_types(Type::Dark, Type::Normal);
		case Species::Raticate_Alolan: return make_types(Type::Dark, Type::Normal);
		case Species::Raichu_Alolan: return make_types(Type::Electric, Type::Psychic);
		case Species::Sandshrew_Alolan: return make_types(Type::Ice, Type::Steel);
		case Species::Sandslash_Alolan: return make_types(Type::Ice, Type::Steel);
		case Species::Vulpix_Alolan: return make_types(Type::Ice);
		case Species::Ninetales_Alolan: return make_types(Type::Ice, Type::Fairy);
		case Species::Diglett_Alolan: return make_types(Type::Ground, Type::Steel);
		case Species::Dugtrio_Alolan: return make_types(Type::Ground, Type::Steel);
		case Species::Meowth_Alolan: return make_types(Type::Dark);
		case Species::Persian_Alolan: return make_types(Type::Dark);
		case Species::Geodude_Alolan: return make_types(Type::Rock, Type::Electric);
		case Species::Graveler_Alolan: return make_types(Type::Rock, Type::Electric);
		case Species::Golem_Alolan: return make_types(Type::Rock, Type::Electric);
		case Species::Grimer_Alolan: return make_types(Type::Poison, Type::Dark);
		case Species::Muk_Alolan: return make_types(Type::Poison, Type::Dark);
		case Species::Exeggutor_Alolan: return make_types(Type::Grass, Type::Dragon);
		case Species::Marowak_Alolan: return make_types(Type::Fire, Type::Ghost);
	}
}
