...
export module tm.stat.ingame_id_to_nature;
...
export using IngameNatureID = bounded::integer<0, 24>;

export constexpr auto ingame_id_to_nature(IngameNatureID const id) -> Nature {
	switch (id.value()) {
...
export constexpr auto ingame_nature_to_id(Nature const nature) -> IngameNatureID {
	switch (nature) {
