...
template<any_active_pokemon ActivePokemonType>
auto base_critical_hit_probability(ActivePokemonType const attacker, MoveName const move_name, Weather const weather) {
	constexpr auto generation = generation_from<ActivePokemonType>;
...
auto critical_hit_probability(any_active_pokemon auto const attacker, MoveName const move, Ability const defender_ability, Weather const weather) -> double {
