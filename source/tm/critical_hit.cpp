...
constexpr auto move_critical_hit(Generation const generation, Moves const move_name) {
	switch (move_name) {
		...
		case Moves::Vise_Grip: return MoveCriticalHit::normal;
		...
		case Moves::Snipe_Shot: return MoveCriticalHit::normal;
		case Moves::Jaw_Lock: return MoveCriticalHit::normal;
		case Moves::Stuff_Cheeks: return MoveCriticalHit::normal;
		case Moves::No_Retreat: return MoveCriticalHit::normal;
		case Moves::Tar_Shot: return MoveCriticalHit::normal;
		case Moves::Magic_Powder: return MoveCriticalHit::normal;
		case Moves::Dragon_Darts: return MoveCriticalHit::normal;
		case Moves::Teatime: return MoveCriticalHit::normal;
		case Moves::Octolock: return MoveCriticalHit::normal;
		case Moves::Bolt_Beak: return MoveCriticalHit::normal;
		case Moves::Fishious_Rend: return MoveCriticalHit::normal;
		case Moves::Court_Change: return MoveCriticalHit::normal;
		case Moves::Max_Flare: return MoveCriticalHit::normal;
		case Moves::Max_Flutterby: return MoveCriticalHit::normal;
		case Moves::Max_Lightning: return MoveCriticalHit::normal;
		case Moves::Max_Strike: return MoveCriticalHit::normal;
		case Moves::Max_Knuckle: return MoveCriticalHit::normal;
		case Moves::Max_Phantasm: return MoveCriticalHit::normal;
		case Moves::Max_Hailstorm: return MoveCriticalHit::normal;
		case Moves::Max_Ooze: return MoveCriticalHit::normal;
		case Moves::Max_Geyser: return MoveCriticalHit::normal;
		case Moves::Max_Airstream: return MoveCriticalHit::normal;
		case Moves::Max_Starfall: return MoveCriticalHit::normal;
		case Moves::Max_Wyrmwind: return MoveCriticalHit::normal;
		case Moves::Max_Mindstorm: return MoveCriticalHit::normal;
		case Moves::Max_Rockfall: return MoveCriticalHit::normal;
		case Moves::Max_Quake: return MoveCriticalHit::normal;
		case Moves::Max_Darkness: return MoveCriticalHit::normal;
		case Moves::Max_Overgrowth: return MoveCriticalHit::normal;
		case Moves::Max_Steelspike: return MoveCriticalHit::normal;
		case Moves::Clangorous_Soul: return MoveCriticalHit::normal;
		case Moves::Body_Press: return MoveCriticalHit::normal;
		case Moves::Decorate: return MoveCriticalHit::normal;
		case Moves::Drum_Beating: return MoveCriticalHit::normal;
		case Moves::Snap_Trap: return MoveCriticalHit::normal;
		case Moves::Pyro_Ball: return MoveCriticalHit::normal;
		case Moves::Behemoth_Blade: return MoveCriticalHit::normal;
		case Moves::Behemoth_Bash: return MoveCriticalHit::normal;
		case Moves::Aura_Wheel: return MoveCriticalHit::normal;
		case Moves::Breaking_Swipe: return MoveCriticalHit::normal;
		case Moves::Branch_Poke: return MoveCriticalHit::normal;
		case Moves::Overdrive: return MoveCriticalHit::normal;
		case Moves::Apple_Acid: return MoveCriticalHit::normal;
		case Moves::Grav_Apple: return MoveCriticalHit::normal;
		case Moves::Spirit_Break: return MoveCriticalHit::normal;
		case Moves::Strange_Steam: return MoveCriticalHit::normal;
		case Moves::Life_Dew: return MoveCriticalHit::normal;
		case Moves::Obstruct: return MoveCriticalHit::normal;
		case Moves::False_Surrender: return MoveCriticalHit::normal;
		case Moves::Meteor_Assault: return MoveCriticalHit::normal;
		case Moves::Eternabeam: return MoveCriticalHit::normal;
		case Moves::Steel_Beam: return MoveCriticalHit::normal;
		case Moves::Expanding_Force: return MoveCriticalHit::normal;
		case Moves::Steel_Roller: return MoveCriticalHit::normal;
		case Moves::Scale_Shot: return MoveCriticalHit::normal;
		case Moves::Meteor_Beam: return MoveCriticalHit::normal;
		case Moves::Shell_Side_Arm: return MoveCriticalHit::normal;
		case Moves::Misty_Explosion: return MoveCriticalHit::normal;
		case Moves::Grassy_Glide: return MoveCriticalHit::normal;
		case Moves::Rising_Voltage: return MoveCriticalHit::normal;
		case Moves::Terrain_Pulse: return MoveCriticalHit::normal;
		case Moves::Skitter_Smack: return MoveCriticalHit::normal;
		case Moves::Burning_Jealousy: return MoveCriticalHit::normal;
		case Moves::Lash_Out: return MoveCriticalHit::normal;
		case Moves::Poltergeist: return MoveCriticalHit::normal;
		case Moves::Corrosive_Gas: return MoveCriticalHit::normal;
		case Moves::Coaching: return MoveCriticalHit::normal;
		case Moves::Flip_Turn: return MoveCriticalHit::normal;
		case Moves::Triple_Axel: return MoveCriticalHit::normal;
		case Moves::Dual_Wingbeat: return MoveCriticalHit::normal;
		case Moves::Scorching_Sands: return MoveCriticalHit::normal;
		case Moves::Jungle_Healing: return MoveCriticalHit::normal;
		case Moves::Wicked_Blow: return MoveCriticalHit::normal;
		case Moves::Surging_Strikes: return MoveCriticalHit::normal;
		case Moves::Thunder_Cage: return MoveCriticalHit::normal;
		case Moves::Dragon_Energy: return MoveCriticalHit::normal;
		case Moves::Freezing_Glare: return MoveCriticalHit::normal;
		case Moves::Fiery_Wrath: return MoveCriticalHit::normal;
		case Moves::Thunderous_Kick: return MoveCriticalHit::normal;
		case Moves::Glacial_Lance: return MoveCriticalHit::normal;
		case Moves::Astral_Barrage: return MoveCriticalHit::normal;
		case Moves::Eerie_Spell: return MoveCriticalHit::normal;
	}
}
