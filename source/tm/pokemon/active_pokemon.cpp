...
private:
	...
	[[no_unique_address]] Confusion confusion;
	[[no_unique_address]] Disable disable;
	...
	[[no_unique_address]] PokemonTypes types{Type::Typeless};
	[[no_unique_address]] YawnCounter<generation> yawn;
	[[no_unique_address]] CurrentHP direct_damage_received = 0_bi;
	...
	[[no_unique_address]] bool damaged = false;
	...
	[[no_unique_address]] bool flinched = false;
	[[no_unique_address]] bool has_focused_energy = false;
	...
	[[no_unique_address]] bool leech_seeded = false;
