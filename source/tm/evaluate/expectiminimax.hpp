...
auto expectiminimax(Team<generation> const & ai, Team<generation> const & foe, Weather, Evaluate<generation>, Depth, std::ostream & log, std::mt19937 & random_engine) -> BestMove;
