...
struct Evaluator {
	...
	auto select_type_of_action(State<generation> const & state, LegalSelections const ai_selections, auto const foe_selections, Depth const depth) -> ScoredSelections {
