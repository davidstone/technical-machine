...
auto power_of_mass_based_moves(Species const species) -> bounded::integer<20, 120> {
	switch (species) {
		...
		case Species::Meowth_Galarian: return 20_bi;
		case Species::Ponyta_Galarian: return 40_bi;
		case Species::Rapidash_Galarian: return 80_bi;
		case Species::Farfetchd_Galarian: return 60_bi;
		case Species::Weezing_Galarian: return 40_bi;
		case Species::Mr_Mime_Galarian: return 80_bi;
		case Species::Corsola_Galarian: return 20_bi;
		case Species::Zigzagoon_Galarian: return 40_bi;
		case Species::Linoone_Galarian: return 60_bi;
		case Species::Darumaka_Galarian: return 60_bi;
		case Species::Darmanitan_Galarian: return 100_bi;
		case Species::Yamask_Galarian: return 20_bi;
		case Species::Stunfisk_Galarian: return 40_bi;
		case Species::Slowpoke_Galarian: return 60_bi;
		case Species::Slowbro_Galarian: return 80_bi;
		case Species::Articuno_Galarian: return 80_bi;
		case Species::Zapdos_Galarian: return 80_bi;
		case Species::Moltres_Galarian: return 80_bi;
		case Species::Slowking_Galarian: return 80_bi;
