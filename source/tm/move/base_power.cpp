...
auto base_power(UserTeam const & attacker_team, ExecutedMove<UserTeam> const executed, DefenderTeam const & defender_team, Weather const weather) -> BasePower {
	...
	switch (executed.move.name) {
		...
		// Generation 8
		case Moves::Max_Guard: return 0_bi;
		case Moves::Dynamax_Cannon: return 100_bi;
		case Moves::Snipe_Shot: return 80_bi;
		case Moves::Jaw_Lock: return 80_bi;
		case Moves::Stuff_Cheeks: return 0_bi;
		case Moves::No_Retreat: return 0_bi;
		case Moves::Tar_Shot: return 0_bi;
		case Moves::Magic_Powder: return 0_bi;
		case Moves::Dragon_Darts: return 50_bi;
		case Moves::Teatime: return 0_bi;
		case Moves::Octolock: return 0_bi;
		case Moves::Bolt_Beak: return 85_bi;
		case Moves::Fishious_Rend: return 85_bi;
		case Moves::Court_Change: return 0_bi;
		case Moves::Max_Flare: return 0_bi;
		case Moves::Max_Flutterby: return 0_bi;
		case Moves::Max_Lightning: return 0_bi;
		case Moves::Max_Strike: return 0_bi;
		case Moves::Max_Knuckle: return 0_bi;
		case Moves::Max_Phantasm: return 0_bi;
		case Moves::Max_Hailstorm: return 0_bi;
		case Moves::Max_Ooze: return 0_bi;
		case Moves::Max_Geyser: return 0_bi;
		case Moves::Max_Airstream: return 0_bi;
		case Moves::Max_Starfall: return 0_bi;
		case Moves::Max_Wyrmwind: return 0_bi;
		case Moves::Max_Mindstorm: return 0_bi;
		case Moves::Max_Rockfall: return 0_bi;
		case Moves::Max_Quake: return 0_bi;
		case Moves::Max_Darkness: return 0_bi;
		case Moves::Max_Overgrowth: return 0_bi;
		case Moves::Max_Steelspike: return 0_bi;
		case Moves::Clangorous_Soul: return 0_bi;
		case Moves::Body_Press: return 80_bi;
		case Moves::Decorate: return 0_bi;
		case Moves::Drum_Beating: return 80_bi;
		case Moves::Snap_Trap: return 35_bi;
		case Moves::Pyro_Ball: return 120_bi;
		case Moves::Behemoth_Blade: return 100_bi;
		case Moves::Behemoth_Bash: return 100_bi;
		case Moves::Aura_Wheel: return 110_bi;
		case Moves::Breaking_Swipe: return 60_bi;
		case Moves::Branch_Poke: return 40_bi;
		case Moves::Overdrive: return 80_bi;
		case Moves::Apple_Acid: return 80_bi;
		case Moves::Grav_Apple: return 80_bi;
		case Moves::Spirit_Break: return 75_bi;
		case Moves::Strange_Steam: return 90_bi;
		case Moves::Life_Dew: return 0_bi;
		case Moves::Obstruct: return 0_bi;
		case Moves::False_Surrender: return 80_bi;
		case Moves::Meteor_Assault: return 150_bi;
		case Moves::Eternabeam: return 160_bi;
		case Moves::Steel_Beam: return 140_bi;
		case Moves::Expanding_Force: return 80_bi;
		case Moves::Steel_Roller: return 130_bi;
		case Moves::Scale_Shot: return 25_bi;
		case Moves::Meteor_Beam: return 120_bi;
		case Moves::Shell_Side_Arm: return 90_bi;
		case Moves::Misty_Explosion: return 100_bi;
		case Moves::Grassy_Glide: return 70_bi;
		case Moves::Rising_Voltage: return 70_bi;
		case Moves::Terrain_Pulse: return 50_bi;
		case Moves::Skitter_Smack: return 70_bi;
		case Moves::Burning_Jealousy: return 70_bi;
		case Moves::Lash_Out: return 75_bi;
		case Moves::Poltergeist: return 110_bi;
		case Moves::Corrosive_Gas: return 0_bi;
		case Moves::Coaching: return 0_bi;
		case Moves::Flip_Turn: return 60_bi;
		case Moves::Triple_Axel: return 20_bi;
		case Moves::Dual_Wingbeat: return 40_bi;
		case Moves::Scorching_Sands: return 70_bi;
		case Moves::Jungle_Healing: return 0_bi;
		case Moves::Wicked_Blow: return 80_bi;
		case Moves::Surging_Strikes: return 25_bi;
		case Moves::Thunder_Cage: return 80_bi;
		case Moves::Freezing_Glare: return 90_bi;
		case Moves::Fiery_Wrath: return 90_bi;
		case Moves::Thunderous_Kick: return 90_bi;
		case Moves::Glacial_Lance: return 130_bi;
		case Moves::Astral_Barrage: return 120_bi;
		case Moves::Eerie_Spell: return 80_bi;
	}
}
