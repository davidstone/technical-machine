...
auto accuracy(Generation const generation, Moves const move, Weather const weather, bool const weather_blocked, bool const user_is_poison) -> BaseAccuracy {
	...
	switch (move) {
		...
		case Moves::Vise_Grip: return 100_bi;
		...
		// Generation 8
		case Moves::Max_Guard: return none;
		case Moves::Dynamax_Cannon: return 100_bi;
		case Moves::Snipe_Shot: return 100_bi;
		case Moves::Jaw_Lock: return 100_bi;
		case Moves::Stuff_Cheeks: return none;
		case Moves::No_Retreat: return none;
		case Moves::Tar_Shot: return 100_bi;
		case Moves::Magic_Powder: return 100_bi;
		case Moves::Dragon_Darts: return 100_bi;
		case Moves::Teatime: return none;
		case Moves::Octolock: return 100_bi;
		case Moves::Bolt_Beak: return 100_bi;
		case Moves::Fishious_Rend: return 100_bi;
		case Moves::Court_Change: return 100_bi;
		case Moves::Max_Flare: return none;
		case Moves::Max_Flutterby: return none;
		case Moves::Max_Lightning: return none;
		case Moves::Max_Strike: return none;
		case Moves::Max_Knuckle: return none;
		case Moves::Max_Phantasm: return none;
		case Moves::Max_Hailstorm: return none;
		case Moves::Max_Ooze: return none;
		case Moves::Max_Geyser: return none;
		case Moves::Max_Airstream: return none;
		case Moves::Max_Starfall: return none;
		case Moves::Max_Wyrmwind: return none;
		case Moves::Max_Mindstorm: return none;
		case Moves::Max_Rockfall: return none;
		case Moves::Max_Quake: return none;
		case Moves::Max_Darkness: return none;
		case Moves::Max_Overgrowth: return none;
		case Moves::Max_Steelspike: return none;
		case Moves::Clangorous_Soul: return none;
		case Moves::Body_Press: return 100_bi;
		case Moves::Decorate: return none;
		case Moves::Drum_Beating: return 100_bi;
		case Moves::Snap_Trap: return 100_bi;
		case Moves::Pyro_Ball: return 90_bi;
		case Moves::Behemoth_Blade: return 100_bi;
		case Moves::Behemoth_Bash: return 100_bi;
		case Moves::Aura_Wheel: return 100_bi;
		case Moves::Breaking_Swipe: return 100_bi;
		case Moves::Branch_Poke: return 100_bi;
		case Moves::Overdrive: return 100_bi;
		case Moves::Apple_Acid: return 100_bi;
		case Moves::Grav_Apple: return 100_bi;
		case Moves::Spirit_Break: return 100_bi;
		case Moves::Strange_Steam: return 95_bi;
		case Moves::Life_Dew: return none;
		case Moves::Obstruct: return 100_bi;
		case Moves::False_Surrender: return none;
		case Moves::Meteor_Assault: return 100_bi;
		case Moves::Eternabeam: return 90_bi;
		case Moves::Steel_Beam: return 95_bi;
		case Moves::Expanding_Force: return 100_bi;
		case Moves::Steel_Roller: return 100_bi;
		case Moves::Scale_Shot: return 90_bi;
		case Moves::Meteor_Beam: return 90_bi;
		case Moves::Shell_Side_Arm: return 100_bi;
		case Moves::Misty_Explosion: return 100_bi;
		case Moves::Grassy_Glide: return 100_bi;
		case Moves::Rising_Voltage: return 100_bi;
		case Moves::Terrain_Pulse: return 100_bi;
		case Moves::Skitter_Smack: return 90_bi;
		case Moves::Burning_Jealousy: return 100_bi;
		case Moves::Lash_Out: return 100_bi;
		case Moves::Poltergeist: return 90_bi;
		case Moves::Corrosive_Gas: return 100_bi;
		case Moves::Coaching: return none;
		case Moves::Flip_Turn: return 100_bi;
		case Moves::Triple_Axel: return 90_bi;
		case Moves::Dual_Wingbeat: return 90_bi;
		case Moves::Scorching_Sands: return 100_bi;
		case Moves::Jungle_Healing: return none;
		case Moves::Wicked_Blow: return 100_bi;
		case Moves::Surging_Strikes: return 100_bi;
		case Moves::Thunder_Cage: return 90_bi;
		case Moves::Dragon_Energy: return 100_bi;
		case Moves::Freezing_Glare: return 100_bi;
		case Moves::Fiery_Wrath: return 100_bi;
		case Moves::Thunderous_Kick: return 100_bi;
		case Moves::Glacial_Lance: return 100_bi;
		case Moves::Astral_Barrage: return 100_bi;
		case Moves::Eerie_Spell: return 100_bi;
	}
}
