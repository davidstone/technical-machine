...
constexpr auto base_pp(Generation const generation, Moves const move) -> bounded::optional<base_type> {
	...
	switch (move) {
		...
		case Moves::Vise_Grip: return 30_bi;
		...
		case Moves::Snipe_Shot: return 15_bi;
		case Moves::Jaw_Lock: return 10_bi;
		case Moves::Stuff_Cheeks: return 10_bi;
		case Moves::No_Retreat: return 5_bi;
		case Moves::Tar_Shot: return 15_bi;
		case Moves::Magic_Powder: return 20_bi;
		case Moves::Dragon_Darts: return 10_bi;
		case Moves::Teatime: return 10_bi;
		case Moves::Octolock: return 15_bi;
		case Moves::Bolt_Beak: return 10_bi;
		case Moves::Fishious_Rend: return 10_bi;
		case Moves::Court_Change: return 10_bi;
		case Moves::Max_Flare: return 10_bi;
		case Moves::Max_Flutterby: return 10_bi;
		case Moves::Max_Lightning: return 10_bi;
		case Moves::Max_Strike: return 10_bi;
		case Moves::Max_Knuckle: return 10_bi;
		case Moves::Max_Phantasm: return 10_bi;
		case Moves::Max_Hailstorm: return 10_bi;
		case Moves::Max_Ooze: return 10_bi;
		case Moves::Max_Geyser: return 10_bi;
		case Moves::Max_Airstream: return 10_bi;
		case Moves::Max_Starfall: return 10_bi;
		case Moves::Max_Wyrmwind: return 10_bi;
		case Moves::Max_Mindstorm: return 10_bi;
		case Moves::Max_Rockfall: return 10_bi;
		case Moves::Max_Quake: return 10_bi;
		case Moves::Max_Darkness: return 10_bi;
		case Moves::Max_Overgrowth: return 10_bi;
		case Moves::Max_Steelspike: return 10_bi;
		case Moves::Clangorous_Soul: return 5_bi;
		case Moves::Body_Press: return 10_bi;
		case Moves::Decorate: return 15_bi;
		case Moves::Drum_Beating: return 10_bi;
		case Moves::Snap_Trap: return 15_bi;
		case Moves::Pyro_Ball: return 5_bi;
		case Moves::Behemoth_Blade: return 5_bi;
		case Moves::Behemoth_Bash: return 5_bi;
		case Moves::Aura_Wheel: return 10_bi;
		case Moves::Breaking_Swipe: return 15_bi;
		case Moves::Branch_Poke: return 40_bi;
		case Moves::Overdrive: return 10_bi;
		case Moves::Apple_Acid: return 10_bi;
		case Moves::Grav_Apple: return 10_bi;
		case Moves::Spirit_Break: return 15_bi;
		case Moves::Strange_Steam: return 10_bi;
		case Moves::Life_Dew: return 10_bi;
		case Moves::Obstruct: return 10_bi;
		case Moves::False_Surrender: return 10_bi;
		case Moves::Meteor_Assault: return 5_bi;
		case Moves::Eternabeam: return 5_bi;
		case Moves::Steel_Beam: return 5_bi;
		case Moves::Expanding_Force: return 10_bi;
		case Moves::Steel_Roller: return 5_bi;
		case Moves::Scale_Shot: return 20_bi;
		case Moves::Meteor_Beam: return 10_bi;
		case Moves::Shell_Side_Arm: return 10_bi;
		case Moves::Misty_Explosion: return 5_bi;
		case Moves::Grassy_Glide: return 20_bi;
		case Moves::Rising_Voltage: return 20_bi;
		case Moves::Terrain_Pulse: return 10_bi;
		case Moves::Skitter_Smack: return 10_bi;
		case Moves::Burning_Jealousy: return 5_bi;
		case Moves::Lash_Out: return 5_bi;
		case Moves::Poltergeist: return 5_bi;
		case Moves::Corrosive_Gas: return 40_bi;
		case Moves::Coaching: return 10_bi;
		case Moves::Flip_Turn: return 20_bi;
		case Moves::Triple_Axel: return 10_bi;
		case Moves::Dual_Wingbeat: return 10_bi;
		case Moves::Scorching_Sands: return 10_bi;
		case Moves::Jungle_Healing: return 10_bi;
		case Moves::Wicked_Blow: return 5_bi;
		case Moves::Surging_Strikes: return 5_bi;
		case Moves::Thunder_Cage: return 15_bi;
		case Moves::Dragon_Energy: return 5_bi;
		case Moves::Freezing_Glare: return 10_bi;
		case Moves::Fiery_Wrath: return 10_bi;
		case Moves::Thunderous_Kick: return 10_bi;
		case Moves::Glacial_Lance: return 5_bi;
		case Moves::Astral_Barrage: return 5_bi;
		case Moves::Eerie_Spell: return 5_bi;
	}
}
