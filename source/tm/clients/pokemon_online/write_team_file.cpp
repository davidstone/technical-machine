...
export module tm.clients.po.write_team_file;
...
void write_blank_stats(Generation const generation, property_tree::ptree_writer pt) {
...
void write_stats(any_pokemon auto const & pokemon, property_tree::ptree_writer pt) {
...
void write_blank_move(property_tree::ptree_writer pt) {
	pt.add("Move", 0);
}

void write_move(Move const move, property_tree::ptree_writer pt) {
	pt.add("Move", move_to_id(move.name()));
}

auto write_blank_pokemon(Generation const generation, property_tree::ptree_writer pt) -> void {
...
void write_pokemon(any_pokemon auto const & pokemon, property_tree::ptree_writer pt) {
	property_tree::ptree_writer member = pt.add("Pokemon", "");
