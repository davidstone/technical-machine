...
TEST_CASE("pokemon showdown: Pokemon Showdown Generation 1 packed_team") {
	constexpr auto initial = "Pika|Pikachu||Honey Gather|Thunderbolt,Surf|Hardy|252,4,248,252,252,252|Genderless|30,2,30,30,30,30||83|]Snorlax|||Honey Gather|Body Slam,Earthquake,Hyper Beam,Rest|Hardy|252,252,252,252,252,252|Genderless|30,30,30,30,30,30||100|"_s;
